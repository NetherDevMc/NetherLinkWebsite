      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="flex flex-col items-center">
          ...
          <div className="flex items-center space-x-3 mb-6">
            <a href="https://discord.gg/HAv4ZaSJk5" target="_blank" rel="noopener noreferrer" className="text-indigo-400 hover:text-indigo-300 transition">
            ...
            <a href="https://github.com/NetherLinkMC" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-gray-300 transition">
              <svg viewBox="0 0 24 24" className="h-6 w-6 fill-current">
